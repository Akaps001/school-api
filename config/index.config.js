...
if (!LONG_TOKEN_SECRET || !SHORT_TOKEN_SECRET || !NACL_SECRET || !JWT_SECRET) {
    throw Error('missing .env variables check index.config (LONG_TOKEN_SECRET, SHORT_TOKEN_SECRET, NACL_SECRET, JWT_SECRET)');
}
